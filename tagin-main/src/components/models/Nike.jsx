...
Command: npx gltfjsx@6.5.3 nike.glb -T 
Files: nike.glb [14.67MB] > /Users/amansinghkaushik/Documents/Tag In/FinalTagIn/tagin-main/public/models/nike-transformed.glb [1.1MB] (93%)
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/models/nike-transformed.glb')
  return (
...
useGLTF.preload('/models/nike-transformed.glb')
